 ...
 */
class CDepartment extends CApiService {
    ...
    public function get($options = []) {
        ...
        if (is_array($options['search'])) {
            ...
            zbx_db_search('department u', $options, $sqlParts);
        }
        ...
        while ($user = DBfetch($res)) {
            ...
            if ($options['countOutput']) {
                ...
                $result[$user['userid']]['total'] = API::User()->get(array_merge($options,['countOutput'=>true]));
            }
        }
