...
class CRoleHelper {
    ...
    public const USERS = "Users";//系统管理-用户管理
    public const ROLES = "Roles";//系统管理-角色管理
    public const TEMPLATEMANAGEMENT = "TemplateManagement";//配置管理-模板管理
    public const AUTODISCOVERYRULE = "AutoDiscoveryRule";//自动发现规则
    public const SOFTWAREUPGRADING = "SoftwareUpgrading";//配置管理-软件升级
    public const ASSETSMANAGEMENT = "AssetsManagement";//资产管理
    public const GENERALDISCOVERY = "GeneralDiscovery";//通用发现

    public const DEVICETYPE = "DeviceType";//设备类型管理

    public const DEVICEDISCOVERY = "DeviceDiscovery";//设备发现

    public const SYSTEMSETTING = "SystemSetting";//系统管理

    public const MONITORINGOVERVIEW = "MonitoringOverview"; //监控概览

    public const EQUIPMENTMONITORING = "EquipmentMonitoring"; //设备监控

    public const MONITORINGSET = "MonitoringSet"; //监控设置
    public const PERSONALCENTER =  "PersonalCenter"; //个人中心
    public const IDC = "Idc";//资产管理-idc
    public const ASSETMANAGEMENT = "AssetsManagement";//资产管理-设备类型管理
    public const ALARMLIST = "AlarmList";//告警管理-告警列表
    public const ALARMHISTORY = "AlarmHistory";//告警管理-历史数据
    public const ALARMSET = "AlarmSet";//告警管理-告警设置

    public const INDEX = "Index";//首页




//    public const Front_User = 'user';
//    public const Front_Role = 'role';
//    public const Front_Template = 'template';
//    public const Front = 'ui.administration';
//    public const UI_SECTION_ADMINISTRATION = 'ui.administration';
//    public const UI_SECTION_ADMINISTRATION = 'ui.administration';
//    public const UI_SECTION_ADMINISTRATION = 'ui.administration';
//    public const UI_SECTION_ADMINISTRATION = 'ui.administration';
    ...
    public static function getFrontElementsByUserType(): array {
        return [
            self::USERS,
            self::ROLES,
            self::TEMPLATEMANAGEMENT,
            self::IDC,
            self::ASSETMANAGEMENT,
            self::ALARMLIST,
            self::ALARMHISTORY,
            self::ALARMSET,
            self::AUTODISCOVERYRULE,
            self::SOFTWAREUPGRADING,
            self::GENERALDISCOVERY,
            self::DEVICETYPE,
            self::MONITORINGOVERVIEW,
            self::EQUIPMENTMONITORING,
            self::MONITORINGSET,
            self::PERSONALCENTER,
            self::INDEX,
            self::ASSETSMANAGEMENT,
