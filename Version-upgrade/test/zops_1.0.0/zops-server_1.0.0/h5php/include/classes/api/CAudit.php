...
class CAudit {
    ...
    public const RESOURCE_IDC = 52;
    public const RESOURCE_HOUSE = 53;

    public const RESOURCE_MANUFACTURER = 54;

    public const RESOURCE_IPMIUSER = 55;

    public const RESOURCE_INVENTORYTYPE = 56;

    public const RESOURCE_MODELTYPE = 57;
	/**
