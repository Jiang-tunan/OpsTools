...
class API {
    ...
    public static function getTotal($api,$options){
        $service =  self::getApi($api);
        ...
        $total = $service->get(array_merge($options,['countOutput'=>true]));
    ...
    public static function IDC() {
        return self::getApi('idc');
    }

    /**
     * @return CInventoryType
     */
    public static function InventoryType() {
        return self::getApi('inventorytype');
    }
     ...
     * @return Cipmiuser
     */
    public static function ipmiuser() {
        return self::getApi('ipmiuser');
    }
    ...
    public static function Manufacturer() {
        return self::getApi('manufacturer');
    }
