...
class CConfigFile {
	...
	public function load() {
        ...
        if(isset($MEDIATYPE["mail_template"])){
            $this->config['MEDIATYPE']["mail_template"] = $MEDIATYPE["mail_template"];
        }

        if(isset($MEDIATYPE["script_dingding"])){
            $this->config['MEDIATYPE']["script_dingding"] = $MEDIATYPE["script_dingding"];
        }


        if(isset($MEDIATYPE["script_wecom"])){
            $this->config['MEDIATYPE']["script_wecom"] = $MEDIATYPE["script_wecom"];
        }

        if(isset($MEDIATYPE["message_dingding"])){
            $this->config['MEDIATYPE']["message_dingding"] = $MEDIATYPE["message_dingding"];
        }

        if(isset($MEDIATYPE["subject_dingding"])){
            $this->config['MEDIATYPE']["subject_dingding"] = $MEDIATYPE["subject_dingding"];
        }

        if(isset($MEDIATYPE["message_wecom"])){
            $this->config['MEDIATYPE']["message_wecom"] = $MEDIATYPE["message_wecom"];
        }

        if(isset($MEDIATYPE["subject_wecom"])){
            $this->config['MEDIATYPE']["subject_wecom"] = $MEDIATYPE["subject_wecom"];
        }
	...
	public function makeGlobal() {
		global $DB, $ZBX_SERVER, $ZBX_SERVER_PORT, $ZBX_SERVER_NAME, $IMAGE_FORMAT_DEFAULT, $HISTORY, $SSO, $MEDIATYPE;
...
$MEDIATYPE[\'mail_template\']		= \''.addcslashes($this->config['MEDIATYPE']['mail_template'], "'\\").'\';
$MEDIATYPE[\'script_dingding\']		= \''.addcslashes($this->config['MEDIATYPE']['script_dingding'], "'\\").'\';
$MEDIATYPE[\'script_wecom\']		= \''.addcslashes($this->config['MEDIATYPE']['script_wecom'], "'\\").'\';
$MEDIATYPE[\'subject_dingding\']		= \''.addcslashes($this->config['MEDIATYPE']['subject_dingding'], "'\\").'\';
$MEDIATYPE[\'message_dingding\']		= \''.addcslashes($this->config['MEDIATYPE']['message_dingding'], "'\\").'\';
$MEDIATYPE[\'subject_wecom\']		= \''.addcslashes($this->config['MEDIATYPE']['subject_wecom'], "'\\").'\';
$MEDIATYPE[\'message_wecom\']		= \''.addcslashes($this->config['MEDIATYPE']['message_wecom'], "'\\").'\';
