...
class CZabbixServer {
    ...
    public function activate(array $data,string $session){
        $request = [
            'session' => $session,
            'request' => 'discovery_rules_activate',
            'version'=>'6.0',
            'data' => $data
        ];
    ...
    public function progress(array $data,string $session){
        $request = [
            'session' => $session,
            'request' => 'discovery_rules_progress',
            'version'=>'6.0',
            'data' => $data
        ];
    ...
    public function stop(array $data,string $session){
        $request = [
            'session' => $session,
            'request' => 'discovery_rules_stop',
            'version'=>'6.0',
            'data' => $data
        ];
	 ...
	 */
	protected function request(array $params,$return = true) {
		// Reset object state.
		$this->error = null;
		$this->total = null;
		$this->debug = [];
